...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('acms_transactions_movements', function (Blueprint $table) {
            ...
            $table->integer('acms_tran_move_refer_type_num')->nullable();
            $table->integer('acms_tran_move_refer_status_num')->nullable();
            $table->integer('acms_tran_move_refer_recive_emp_num')->nullable();
            $table->string('acms_tran_move_refer_recive_dt')->nullable();
