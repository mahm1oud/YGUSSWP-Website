...
@section('content')
    <div class="main-wrapper">
        <div class="account-content">
            <a href="{{ route('form/job/list') }}" class="btn btn-primary apply-btn">الوظائف الشاغرة</a>
            <div class="container">
                <!-- Account Logo -->
                ...
                <div class="account-box">
                    <div class="account-wrapper">
                        <h3 class="account-title">نظام المنظمة العامة</h3>
                        <p class="account-subtitle">الرجاء تسجيل الدخول</p>
                        <!-- Account Form -->
