...
<head>
	...
	<title>نظام المنظمة العامة</title>
	<!-- Favicon -->
		...
		<div class="header">
			...
			<div class="header-left">
				<a href="{{ route('home') }}" class="logo">
					<img src="{{ URL::to('/assets/img/'. Auth::user()->avatar) }}" width="170" height="50" alt="">
				</a>
			</div>
			<!-- /Logo -->
			...
			<ul class="nav user-menu">
				...
				<li class="nav-item dropdown has-arrow flag-nav">
					...
					<div class="dropdown-menu dropdown-menu-left">
                        {{--{{app()->getLocale()=='ar'? 'arablic':'English'}}
                        {{Url(app()->getLocale()=='en'? 'ar':'en')}}
                        {{app()->setlocale()()=='en'? 'English':'عربي'}}
                        {{app()->getLocale()=='ar'? 'عربي':'English'}}
                        --}}
						<a href="javascript:void(0);" class="dropdown-item"  >
						<img src="{{ URL::to('assets/img/flags/us.png') }}" alt="" height="16" >English</a>
						<a href="javascript:void(0);" class="dropdown-item"  >
						<img src="{{ URL::to('assets/img/flags/kh.png') }}" alt="" height="16">عربي</a>
					</div>
				</li>
				<!-- /Flag -->
				...
				<li class="nav-item dropdown has-arrow main-drop">
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="{{ route('profile_user') }}">المعلومات الشخصية</a>
						<a class="dropdown-item" href="{{ route('company/settings/page') }}">الاعدادات</a>
