...
class SettingController extends Controller
{
    ...
    public function companySettings()
    {
        ...
        return view('settings.company.companysettings',compact('companySettings'));
    }
    ...
    public function rolesPermissions()
    {
        ...
        return view('settings.permissions.rolespermissions',compact('rolesPermissions'));
    }
    ...
    {
        return view('settings.company.localization');
    }

    /** salary settings */
    public function salarySettingsIndex()
    {
        return view('settings.company.salary-settings');
    }

    /** email Settings */
    public function emailSettingsIndex()
    {
        return view('settings.company.email-settings');
    }
}
